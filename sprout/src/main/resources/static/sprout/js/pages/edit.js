...
$(document).ready(function () {
    let deleteFileListButton = document.querySelectorAll(".addDeleteFileList");

    for (const deleteFileListButtonElement of deleteFileListButton) {
...
function addDeleteFileList(savedFileName) {
    let input = document.createElement("input");
    input.classList.add("deleteFileList");
    input.type = "text";
    input.name = "deleteFileList";
    input.setAttribute("value", savedFileName);

    document.querySelector(".deleteFileList").appendChild(input);
    deleteTag(document.getElementById(savedFileName).parentElement);
}